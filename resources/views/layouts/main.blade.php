          ...
          <div class="flex items-center justify-between h-16">
            ...
            <a href="#" class="flex items-center gap-3">
              <svg width="40" height="40" viewBox="0 0 56 56" fill="none"
                ...
                <rect x="10" y="4" width="36" height="7" rx="3"
                  fill="#C8A97A" />
                <rect x="10" y="10" width="5" height="26" rx="2.5"
                  fill="#8B6F47" />
                <rect x="41" y="10" width="5" height="26" rx="2.5"
                  fill="#8B6F47" />
                <rect x="12" y="22" width="32" height="18" rx="3"
                  fill="#A0785A" />
                <rect x="12" y="22" width="32" height="5" rx="2"
                  fill="#C8A97A" />
                <rect x="12" y="38" width="8" height="14" rx="3"
                  fill="#8B6F47" />
                <rect x="36" y="38" width="8" height="14" rx="3"
                  fill="#8B6F47" />
                <rect x="10" y="36" width="36" height="6" rx="3"
                  fill="#8B6F47" />
              </svg>
              <div class="flex flex-col leading-tight">
                ...
                <span
                  class="text-xs font-medium text-wood-600 tracking-widest">FURNITURE</span>
              </div>
            </a>
            ...
            <div class="hidden md:flex items-center gap-8">
              <a href="#"
                class="text-wood-600 hover:text-wood-500 transition-colors">Beranda</a>
              <a href="#"
                class="text-wood-600 hover:text-wood-500 transition-colors">Produk</a>
              <a href="#"
                class="text-wood-600 hover:text-wood-500 transition-colors">Tentang</a>
              <a href="#"
                class="text-wood-600 hover:text-wood-500 transition-colors">Kontak</a>
            </div>
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="relative hidden sm:block">
                <span
                  class="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none text-wood-400">
              ...
              <button class="relative p-1">
                <svg class="w-6 h-6 text-wood-700" fill="none"
              ...
              <label for="menu-toggle"
                class="md:hidden cursor-pointer p-1 group">
                <div
                  class="w-6 flex flex-col gap-[5px] transition-all duration-300">
                  <span
      ...
      <main class="max-w-6xl mx-auto px-6 py-8">
        ...
        {{-- <section class="bg-white dark:bg-gray-900">
          <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
            <h2
              class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact
              Us</h2>
            <p
              class="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got
              a technical issue? Want to send feedback about a beta feature?
            ...
            <form action="#" class="space-y-8">
              ...
              <button type="submit"
                class="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-wood-700 sm:w-fit hover:bg-wood-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-wood-600 dark:hover:bg-wood-700 dark:focus:ring-primary-800">Send
                message</button>
            </form>
          </div>
        </section> --}}
          ...
          <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
              ...
              <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                  <h2
                    class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Follow
                    us</h2>
                  <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                ...
                <div>
                  <h2
                    class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Legal</h2>
                  <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
