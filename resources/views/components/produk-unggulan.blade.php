    ...
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
        ...
        <div class="mb-4 items-end justify-between space-y-4 sm:flex sm:space-y-0 md:mb-8">
            <div>
                {{-- <nav class="flex" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        <li class="inline-flex items-center">
                            <a href="#"
                                class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-wood-600 dark:text-gray-400 dark:hover:text-white">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#"
                                    class="ms-1 text-sm font-medium text-gray-700 hover:text-wood-600 dark:text-gray-400 dark:hover:text-white md:ms-2">Products</a>
                            </div>
                        </li>
                ...
                <h2 class="mt-3 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Produk Unggulan</h2>
            </div>
            <div class="flex items-center space-x-4">
                {{-- <button data-modal-toggle="filterModal" data-modal-target="filterModal" type="button"
                    class="flex w-full items-center justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-wood-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700 sm:w-auto">
        ...
        <div class="relative h-full w-full max-w-xl md:h-auto">
            ...
            <div class="relative rounded-lg bg-white shadow dark:bg-gray-800">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="flex items-center">
                                    <input id="apple" type="checkbox" value=""
                                        class="h-4 w-4 rounded border-gray-300 bg-gray-100 text-wood-600 focus:ring-2 focus:ring-wood-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-wood-600" />
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div class="col-span-2 flex items-center justify-between space-x-2">
                                    <input type="number" id="min-price-input" value="300" min="0"
                                        max="7000"
                                        class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-wood-500 focus:ring-wood-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-wood-500 dark:focus:ring-wood-500 "
                                ...
                                <li class="w-full border-r border-gray-200 dark:border-gray-600">
                                    <div class="flex items-center pl-3">
                                        <input id="condition-all" type="radio" value=""
                                            ...
                                            class="h-4 w-4 border-gray-300 bg-gray-100 text-wood-600 focus:ring-2 focus:ring-wood-500 dark:border-gray-500 dark:bg-gray-600 dark:ring-offset-gray-700 dark:focus:ring-wood-600" />
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        ...
                                        <label for="blue"
                                            ...
                                            <div class="mr-2 h-3.5 w-3.5 rounded-full bg-wood-600"></div>
                                            Blue
                                        </label>
                                    </div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center">
                                        <input id="five-stars" type="radio" value="" name="rating"
                                            class="h-4 w-4 border-gray-300 bg-gray-100 text-wood-600 focus:ring-2 focus:ring-wood-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-wood-600" />
                            ...
                            <ul class="grid grid-cols-2 gap-4">
                                <li>
                                    ...
                                    <label for="delivery-usa"
                                        class="inline-flex w-full cursor-pointer items-center justify-between rounded-lg border border-gray-200 bg-white p-2 text-gray-500 hover:bg-gray-100 hover:text-gray-600 peer-checked:border-wood-600 peer-checked:text-wood-600 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:peer-checked:text-wood-500 md:p-5">
                                        <div class="block">
                ...
                <div class="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                    <button type="submit"
                        class="rounded-lg bg-wood-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-wood-800 focus:outline-none focus:ring-4 focus:ring-wood-300 dark:bg-wood-700 dark:hover:bg-wood-800 dark:focus:ring-wood-800">Show
                        50 results</button>
                    <button type="reset"
                        class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-wood-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Reset</button>
                </div>
            </div>
        </div>
    </form> --}}
